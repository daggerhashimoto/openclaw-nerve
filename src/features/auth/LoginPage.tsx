      ...
      <div className="shell-panel relative w-full max-w-[min(92vw,980px)] overflow-hidden rounded-[28px]">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
          <div className="border-b border-border/70 bg-gradient-to-br from-background via-card/90 to-secondary/90 px-6 py-8 sm:px-8 lg:border-b-0 lg:border-r">
            ...
            <div className="mt-6 text-[10px] font-mono uppercase tracking-[0.36em] text-primary/80">
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="shell-panel rounded-2xl px-4 py-3">
                <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-muted-foreground">Sessions</div>
                <div className="mt-2 text-sm font-medium text-foreground">Live agent context</div>
              </div>
              <div className="shell-panel rounded-2xl px-4 py-3">
                <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-muted-foreground">Workspace</div>
                <div className="mt-2 text-sm font-medium text-foreground">Files, memory, and skills</div>
              </div>
              <div className="shell-panel rounded-2xl px-4 py-3">
                <div className="text-[10px] font-mono uppercase tracking-[0.26em] text-muted-foreground">Telemetry</div>
          ...
          <div className="px-6 py-8 sm:px-8">
            <div className="text-[10px] font-mono uppercase tracking-[0.34em] text-primary/80">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              <div>
                <label htmlFor="nerve-password" className="mb-2 block text-[11px] font-mono uppercase tracking-[0.24em] text-muted-foreground">
                  Password
                </label>
                <Input
                  ref={inputRef}
              ...
              <Button
                ...
                size="lg"
                className="w-full font-mono text-[11px] uppercase tracking-[0.26em]"
              >
